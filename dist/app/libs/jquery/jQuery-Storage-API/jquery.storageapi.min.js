...
!function (e) {
  ...
  function t(t) {
    var r,
        ...
        s = window[t],
        a = arguments,
        u = a[1];if (2 > o) throw Error("Minimum 2 arguments must be given");if (e.isArray(u)) {
      i = {};for (var f in u) {
        r = u[f];try {
    ...
    var r,
        ...
        a = s[1],
        u = s[2],
        f = {};if (2 > n || !e.isPlainObject(a) && 3 > n) throw Error("Minimum 3 arguments must be given or second parameter must be an object");if (e.isPlainObject(a)) {
      for (var c in a) {
        r = a[c], e.isPlainObject(r) ? o.setItem(c, JSON.stringify(r)) : o.setItem(c, r);
      }return a;
    }if (3 == n) return "object" == (typeof u === "undefined" ? "undefined" : _typeof(u)) ? o.setItem(a, JSON.stringify(u)) : o.setItem(a, u), u;try {
      i = o.getItem(a), null != i && (f = JSON.parse(i));
    } catch (m) {}i = f;for (var c = 2; n - 2 > c; c++) {
    ...
    var r,
        ...
        o = window[t],
        s = arguments,
        a = s[1];if (2 > n) throw Error("Minimum 2 arguments must be given");if (e.isArray(a)) {
      for (var u in a) {
        o.removeItem(a[u]);
      }return !0;
    }if (2 == n) return o.removeItem(a), !0;try {
      ...
      delete i[s[u][c]];
    } else delete i[s[u]];return o.setItem(a, JSON.stringify(r)), !0;
  }function n(t, r) {
    var n = a(t);for (var o in n) {
      i(t, n[o]);
    ...
    var i = arguments.length,
        n = arguments,
        s = (window[r], n[1]);if (1 == i) return 0 == a(r).length;if (e.isArray(s)) {
      for (var u = 0; u < s.length; u++) {
        if (!o(r, s[u])) return !1;
      }return !0;
    }try {
      var f = t.apply(this, arguments);e.isArray(n[i - 1]) || (f = { totest: f });for (var u in f) {
    ...
    var i = arguments.length,
        n = arguments,
        o = (window[r], n[1]);if (2 > i) throw Error("Minimum 2 arguments must be given");if (e.isArray(o)) {
      for (var a = 0; a < o.length; a++) {
        if (!s(r, o[a])) return !1;
      }return !0;
    }try {
      var u = t.apply(this, arguments);e.isArray(n[i - 1]) || (u = { totest: u });for (var a in u) {
    ...
    var t = "jsapi";try {
      ...
      m = "ss_",
      g = f("localStorage"),
      l = { _type: "", _ns: "", _callMethod: function _callMethod(e, t) {
      var r = [this._type],
          t = Array.prototype.slice.call(t),
          i = t[0];return this._ns && r.push(this._ns), "string" == typeof i && -1 !== i.indexOf(".") && (t.shift(), [].unshift.apply(t, i.split("."))), [].push.apply(r, t), e.apply(this, r);
    }, get: function get() {
      return this._callMethod(t, arguments);
    }, set: function set() {
      var t = arguments.length,
          i = arguments,
          n = i[0];if (1 > t || !e.isPlainObject(n) && 2 > t) throw Error("Minimum 2 arguments must be given or first parameter must be an object");if (e.isPlainObject(n) && this._ns) {
        for (var o in n) {
          r(this._type, this._ns, o, n[o]);
        }return n;
      }var s = this._callMethod(r, i);return this._ns ? s[n.split(".")[0]] : s;
    }, remove: function remove() {
      if (arguments.length < 1) throw Error("Minimum 1 argument must be given");return this._callMethod(i, arguments);
      ...
      if (arguments.length < 1) throw Error("Minimum 1 argument must be given");return this._callMethod(s, arguments);
    }, keys: function keys() {
      return this._callMethod(a, arguments);
    } };if (e.cookie) {
    window.name || (window.name = Math.floor(1e8 * Math.random()));var h = { _cookie: !0, _prefix: "", _expires: null, _path: null, _domain: null, setItem: function setItem(t, r) {
      ...
      } };g || (window.localCookieStorage = e.extend({}, h, { _prefix: c, _expires: 3650 }), window.sessionCookieStorage = e.extend({}, h, { _prefix: m + window.name + "_" })), window.cookieStorage = e.extend({}, h), e.cookieStorage = e.extend({}, l, { _type: "cookieStorage", setExpires: function setExpires(e) {
