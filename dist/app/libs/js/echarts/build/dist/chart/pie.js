...
define("echarts/chart/pie", ["require", "./base", "zrender/shape/Text", "zrender/shape/Ring", "zrender/shape/Circle", "zrender/shape/Sector", "zrender/shape/Polyline", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/math", "zrender/tool/color", "../chart"], function (e) {
  function t(e, t, n, a, o) {
    i.call(this, e, t, n, a, o);var r = this;r.shapeHandler.onmouseover = function (e) {
      var t = e.target,
          ...
          m = r.getLabel(i, n, a, o, d, c, !0);m && r.zr.addHoverShape(m);var p = r.getLabelLine(i, n, o, t.style.r0, t.style.r, d, c, !0);p && r.zr.addHoverShape(p);
    }, this.refresh(a);
  }var i = e("./base"),
      ...
      for (var t, i = this.series, n = i[e], a = n.data, o = this.component.legend, r = 0, s = 0, l = 0, h = Number.NEGATIVE_INFINITY, d = [], c = 0, m = a.length; m > c; c++) {
        ...
        }this._autoLabelLayout(d, g, y);for (var c = 0, m = d.length; m > c; c++) {
          this.shapeList.push(d[c]);
        }d = null;
      }
    }, _buildItem: function _buildItem(e, t, i, n, a, o, r, s, l, d, c) {
      var m = this.series,
          p = ((d + l) / 2 + 360) % 360,
          u = this.getSector(t, i, n, a, o, r, s, l, d, c);h.pack(u, m[t], t, m[t].data[i], i, m[t].data[i].name, n), e.push(u);var g = this.getLabel(t, i, n, o, p, c, !1),
          V = this.getLabelLine(t, i, o, r, s, p, c, !1);V && (h.pack(V, m[t], t, m[t].data[i], i, m[t].data[i].name, n), e.push(V)), g && (h.pack(g, m[t], t, m[t].data[i], i, m[t].data[i].name, n), g._labelLine = V, e.push(g));
    }, getSector: function getSector(e, t, i, n, a, o, s, l, h, d) {
      var p = this.series,
          u = p[e],
          g = u.data[t],
          V = [g, u],
          ...
          b = { zlevel: u.zlevel, z: u.z, clickable: this.deepQuery(V, "clickable"), style: { x: a[0], y: a[1], r0: o, r: s, startAngle: l, endAngle: h, brushType: "both", color: f, lineWidth: U.borderWidth, strokeColor: U.borderColor, lineJoin: "round" }, highlightStyle: { color: _, lineWidth: y.borderWidth, strokeColor: y.borderColor, lineJoin: "round" }, _seriesIndex: e, _dataIndex: t };if (n) {
        var x = ((b.style.startAngle + b.style.endAngle) / 2).toFixed(2) - 0;b.style._hasSelected = !0, b.style._x = b.style.x, b.style._y = b.style.y;var k = this.query(u, "selectedOffset");b.style.x += c.cos(x, !0) * k, b.style.y -= c.sin(x, !0) * k, this._selected[e][t] = !0;
      } else this._selected[e][t] = !1;return this._selectedMode && (b.onclick = this.shapeHandler.onclick), this.deepQuery([g, u, this.option], "calculable") && (this.setCalculable(b), b.draggable = !0), (this._needLabel(u, g, !0) || this._needLabelLine(u, g, !0)) && (b.onmouseover = this.shapeHandler.onmouseover), b = new r(b);
    }, getLabel: function getLabel(e, t, i, a, o, r, s) {
      var l = this.series,
          h = l[e],
          m = h.data[t];if (this._needLabel(h, m, s)) {
        var p,
            u,
            g,
            V = s ? "emphasis" : "normal",
            ...
            k = "middle";y.position = y.position || U.normal.label.position, "center" === y.position ? (p = _, u = b, g = "center") : "inner" === y.position || "inside" === y.position ? (x = (x[0] + x[1]) * (y.distance || .5), p = Math.round(_ + x * c.cos(o, !0)), u = Math.round(b - x * c.sin(o, !0)), r = "#fff", g = "center") : (x = x[1] - -U[V].labelLine.length, p = Math.round(_ + x * c.cos(o, !0)), u = Math.round(b - x * c.sin(o, !0)), g = o >= 90 && 270 >= o ? "right" : "left"), "center" != y.position && "inner" != y.position && "inside" != y.position && (p += "left" === g ? 20 : -20), m.__labelX = p - ("left" === g ? 5 : -5), m.__labelY = u;var v = new n({ zlevel: h.zlevel, z: h.z + 1, hoverable: !1, style: { x: p, y: u, color: f.color || r, text: this.getLabelText(e, t, i, V), textAlign: f.align || g, textBaseline: f.baseline || k, textFont: this.getFont(f) }, highlightStyle: { brushType: "fill" } });return v._radius = x, v._labelPosition = y.position || "outer", v._rect = v.getRect(v.style), v._seriesIndex = e, v._dataIndex = t, v;
      }
    }, getLabelText: function getLabelText(e, t, i, n) {
      var a = this.series,
          o = a[e],
          r = o.data[t],
          s = this.deepQuery([r, o], "itemStyle." + n + ".label.formatter");return s ? "function" == typeof s ? s.call(this.myChart, { seriesIndex: e, seriesName: o.name || "", series: o, dataIndex: t, data: r, name: r.name, value: r.value, percent: i }) : "string" == typeof s ? (s = s.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{d}", "{d0}"), s = s.replace("{a0}", o.name).replace("{b0}", r.name).replace("{c0}", r.value).replace("{d0}", i)) : void 0 : r.name;
    }, getLabelLine: function getLabelLine(e, t, i, n, a, o, r, l) {
      var h = this.series,
          m = h[e],
          p = m.data[t];if (this._needLabelLine(m, p, l)) {
        var u = l ? "emphasis" : "normal",
            ...
            x = c.cos(o, !0),
            k = c.sin(o, !0);return new s({ zlevel: m.zlevel, z: m.z + 1, hoverable: !1, style: { pointList: [[y + _ * x, f - _ * k], [y + b * x, f - b * k], [p.__labelX, p.__labelY]], strokeColor: U.color || r, lineType: U.type, lineWidth: U.width }, _seriesIndex: e, _dataIndex: t });
      }
    }, _needLabel: function _needLabel(e, t, i) {
      return this.deepQuery([t, e], "itemStyle." + (i ? "emphasis" : "normal") + ".label.show");
    }, _needLabelLine: function _needLabelLine(e, t, i) {
      return this.deepQuery([t, e], "itemStyle." + (i ? "emphasis" : "normal") + ".labelLine.show");
    }, _autoLabelLayout: function _autoLabelLayout(e, t, i) {
    ...
    }, _layoutCalculate: function _layoutCalculate(e, t, i, n) {
      function a(t, i, n) {
        for (var a = t; i > a; a++) {
      ...
      }this.zr.getHeight() - l < 0 && o(h - 1, l - this.zr.getHeight());for (var m = 0; h > m; m++) {
        e[m]._rect.y >= t[1] ? c.push(e[m]) : d.push(e[m]);
      }r(c, !0, t, i, n), r(d, !1, t, i, n);
    }, reformOption: function reformOption(e) {
      var t = d.merge;return e = t(t(e || {}, d.clone(this.ecTheme.pie || {})), d.clone(l.pie)), e.itemStyle.normal.label.textStyle = this.getTextStyle(e.itemStyle.normal.label.textStyle), e.itemStyle.emphasis.label.textStyle = this.getTextStyle(e.itemStyle.emphasis.label.textStyle), this.z = e.z, this.zlevel = e.zlevel, e;
      ...
      function i() {
        ...
        a[e[o][0]] = e[o];
          ...
          d = {},
          c = {},
          m = this.shapeList;this.shapeList = [];for (var p, u, g, V = {}, o = 0, r = e.length; r > o; o++) {
        ...
        switch (p = this.shapeList[o]._seriesIndex, U = this.shapeList[o]._dataIndex, y = p + "_" + U, this.shapeList[o].type) {case "sector":
            h[y] = this.shapeList[o];break;case "text":
            d[y] = this.shapeList[o];break;case "polyline":
            c[y] = this.shapeList[o];}
      }this.shapeList = [];for (var f, o = 0, r = m.length; r > o; o++) {
        if (p = m[o]._seriesIndex, a[p]) {
          if (U = m[o]._dataIndex + V[p], y = p + "_" + U, f = h[y], !f) continue;if ("sector" === m[o].type) "delete" != f ? (s++, this.zr.animate(m[o].id, "style").when(400, { startAngle: f.style.startAngle, endAngle: f.style.endAngle }).done(i).start()) : (s++, this.zr.animate(m[o].id, "style").when(400, V[p] < 0 ? { startAngle: m[o].style.startAngle } : { endAngle: m[o].style.endAngle }).done(i).start());else if ("text" === m[o].type || "polyline" === m[o].type) if ("delete" === f) this.zr.delShape(m[o].id);else switch (m[o].type) {case "text":
              s++, f = d[y], this.zr.animate(m[o].id, "style").when(400, { x: f.style.x, y: f.style.y }).done(i).start();break;case "polyline":
              s++, f = c[y], this.zr.animate(m[o].id, "style").when(400, { pointList: f.style.pointList }).done(i).start();}
        }
      }this.shapeList = m, s || t && t();
    }, onclick: function onclick(e) {
      var t = this.series;if (this.isClick && e.target) {
        this.isClick = !1;for (var i, n = e.target, a = n.style, o = h.get(n, "seriesIndex"), r = h.get(n, "dataIndex"), s = 0, d = this.shapeList.length; d > s; s++) {
          if (this.shapeList[s].id === n.id) {
            if (o = h.get(n, "seriesIndex"), r = h.get(n, "dataIndex"), a._hasSelected) n.style.x = n.style._x, n.style.y = n.style._y, n.style._hasSelected = !1, this._selected[o][r] = !1;else {
              var m = ((a.startAngle + a.endAngle) / 2).toFixed(2) - 0;n.style._hasSelected = !0, this._selected[o][r] = !0, n.style._x = n.style.x, n.style._y = n.style.y, i = this.query(t[o], "selectedOffset"), n.style.x += c.cos(m, !0) * i, n.style.y -= c.sin(m, !0) * i;
