...
;(function ($, echarts) {
    ...
    Chart.prototype.draw = function () {
        ...
        if (opt.url) {
            ...
            var option = typeof opt.option == 'function' ? opt.option.call(this, that.chart) : opt.option;
    ...
    function Plugin(option) {
        return this.each(function () {
            ...
            var options = $.extend({}, Chart.DEFAULTS, $this.data(), (typeof option === "undefined" ? "undefined" : _typeof(option)) == 'object' && option);
...
//# sourceMappingURL=jquery.echarts.js.map