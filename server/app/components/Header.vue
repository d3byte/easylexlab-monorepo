<template>
    <div class="app-header white box-shadow" v-if="logged">
        <div class="navbar">
          ...
          <span class="pull-left m-r">
            ...
            <!-- navbar collapse -->
            <div class="collapse navbar-toggleable-sm pull-center" id="collapse">
                <!-- link and dropdown -->
                <ul class="nav navbar-nav">
                    <li class="nav-item" v-if="user.permissions == 'student' ? true : false">
                        <router-link to="/profile/stats" class="nav-link">Статистика</router-link>
                    </li>
                    <li class="nav-item" v-if="user.permissions == 'teacher'">
